    ...
    const [dataRes, count] = await prisma.$transaction([
        prisma.result.findMany({
            ...
            include: {
                ...
                exam: {include: {lesson: {select: {class: {select:{name:true}}, teacher: {select:{name:true, surname:true}}}}}},
                assignment: {include: {lesson: {select: {class: {select:{name:true}}, teacher: {select:{name:true, surname:true}}}}}},
            },
            take: ITEM_PER_PAGE,
    ...
    return (
        <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0'>
            ...
            <div className='flex items-center justify-between'>
                <h1 className='hidden md:block text-lf font-semibold'>All Results</h1>
